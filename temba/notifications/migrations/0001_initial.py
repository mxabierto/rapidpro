...
class Migration(migrations.Migration):
    ...
    dependencies = [migrations.swappable_dependency(settings.AUTH_USER_MODEL), ("orgs", "0049_auto_20181122_1907")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org_dest', models.ForeignKey(help_text='The destination organization', on_delete=django.db.models.deletion.PROTECT, related_name='org_dest', to='orgs.Org', verbose_name='Org_destine')),
                ('org_orig', models.ForeignKey(blank=True, help_text='The origin organization', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='org_origin', to='orgs.Org', verbose_name='Org_origin')),
            ],
            options={
                'abstract': False,
            },
